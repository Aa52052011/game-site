 ...
 * @param {{ mode?: "fetch" | "beacon" | "fetch-then-beacon" | "beacon-then-fetch" }} [options]
 */
...
export function trackPageView(pagePath) {
  ...
  trackEvent("page_view", { page_path: pagePath }, { mode: "fetch-then-beacon" });
}
